...
<body>
    ...
    <h1 class="text-center">Convert Opus to MP3</h1>
    <form action="mp3conOpus.php" method="post" enctype="multipart/form-data">
        <div class="content-row text-center">
            <label class="column btn input-content">
                <input type="file" name="opusFile" accept=".opus" style="display: none;" onchange="updateFileName(this)">
