...
<body>
    ...
    <h1 class="text-center">Convert Wav to MP3</h1>
    <form action="mp3conWav.php" method="post" enctype="multipart/form-data">
        <div class="content-row text-center">
            <label class="column btn input-content">
                <input type="file" name="wavFile" accept=".wav" style="display: none;" onchange="updateFileName(this)">
